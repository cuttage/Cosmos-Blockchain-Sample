...
import { WeightedVoteOption } from "cuttage-cosmoschain-client-ts/cosmos.gov.v1beta1/types"
import { TextProposal } from "cuttage-cosmoschain-client-ts/cosmos.gov.v1beta1/types"
import { Deposit } from "cuttage-cosmoschain-client-ts/cosmos.gov.v1beta1/types"
import { Proposal } from "cuttage-cosmoschain-client-ts/cosmos.gov.v1beta1/types"
import { TallyResult } from "cuttage-cosmoschain-client-ts/cosmos.gov.v1beta1/types"
import { Vote } from "cuttage-cosmoschain-client-ts/cosmos.gov.v1beta1/types"
import { DepositParams } from "cuttage-cosmoschain-client-ts/cosmos.gov.v1beta1/types"
import { VotingParams } from "cuttage-cosmoschain-client-ts/cosmos.gov.v1beta1/types"
import { TallyParams } from "cuttage-cosmoschain-client-ts/cosmos.gov.v1beta1/types"
