...
import CuttageCosmoschainCosmoschain from './cuttage.cosmoschain.cosmoschain'
...
import CosmosGovV1 from './cosmos.gov.v1'
import CosmosGovV1Beta1 from './cosmos.gov.v1beta1'
import CosmosGroupV1 from './cosmos.group.v1'
import CosmosMintV1Beta1 from './cosmos.mint.v1beta1'
import CosmosNftV1Beta1 from './cosmos.nft.v1beta1'
...
export default { 
  CuttageCosmoschainCosmoschain: load(CuttageCosmoschainCosmoschain, 'cuttage.cosmoschain.cosmoschain'),
  ...
  CosmosGovV1: load(CosmosGovV1, 'cosmos.gov.v1'),
  CosmosGovV1Beta1: load(CosmosGovV1Beta1, 'cosmos.gov.v1beta1'),
  CosmosGroupV1: load(CosmosGroupV1, 'cosmos.group.v1'),
  CosmosMintV1Beta1: load(CosmosMintV1Beta1, 'cosmos.mint.v1beta1'),
  CosmosNftV1Beta1: load(CosmosNftV1Beta1, 'cosmos.nft.v1beta1'),
