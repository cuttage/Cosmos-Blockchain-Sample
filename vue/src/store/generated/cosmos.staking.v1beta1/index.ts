import { Client, registry, MissingWalletError } from 'cuttage-cosmoschain-client-ts'

import { StakeAuthorization } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { StakeAuthorization_Validators } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { LastValidatorPower } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { HistoricalInfo } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { CommissionRates } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { Commission } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { Description } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { Validator } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { ValAddresses } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { DVPair } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { DVPairs } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplet } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplets } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { Delegation } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegation } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegationEntry } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntry } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { Redelegation } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { Params } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { DelegationResponse } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntryResponse } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationResponse } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
import { Pool } from "cuttage-cosmoschain-client-ts/cosmos.staking.v1beta1/types"
...
export default {
	...
	actions: {
		...
		async sendMsgCancelUnbondingDelegation({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.CosmosStakingV1Beta1.tx.sendMsgCancelUnbondingDelegation({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
